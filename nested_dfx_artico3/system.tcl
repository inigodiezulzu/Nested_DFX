...
# Hierarchical cell: artico3_base
proc create_hier_cell_artico3_base { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_artico3_base() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net dfx_axi_shutdown_man_0_M_AXI [get_bd_intf_pins s00_axi] [get_bd_intf_pins artico3_shuffler_0/s00_axi]
  connect_bd_intf_net -intf_net dfx_axi_shutdown_man_1_M_AXI [get_bd_intf_pins s01_axi] [get_bd_intf_pins artico3_shuffler_0/s01_axi]

  # Create port connections
  connect_bd_net -net artico3_shuffler_0_interrupt  [get_bd_pins artico3_shuffler_0/interrupt] \
  [get_bd_pins interrupt]
  connect_bd_net -net reset_0_peripheral_aresetn  [get_bd_pins s_axi_aresetn] \
...
\
  ...
  # Create instance: axi_a3ctrl, and set properties
  ...
  # Create instance: axi_a3data, and set properties
  set axi_a3data [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_a3data ]
  set_property -dict [list \
    CONFIG.NUM_MI {1} \
    CONFIG.NUM_SI {1} \
  ] $axi_a3data
  ...
  set_property -dict [list \
    CONFIG.ALL_PARAMS {HAS_AXI_LITE 1 HAS_SIGNAL_CONTROL 0 HAS_SIGNAL_STATUS 0 INTF {irq {ID 0 VLNV xilinx.com:signal:interrupt_rtl:1.0 SIGNALS {INTERRUPT {PRESENT 1 WIDTH 1}}}}} \
  ...
  # Create instance: artico3_base
  create_hier_cell_artico3_base [current_bd_instance .] artico3_base

  # Create interface connections
  connect_bd_intf_net -intf_net axi_a3ctrl_M00_AXI [get_bd_intf_pins axi_a3ctrl/M00_AXI] [get_bd_intf_pins dfx_axi_shutdown_man_0/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_a3ctrl_M01_AXI [get_bd_intf_pins axi_a3ctrl/M01_AXI] [get_bd_intf_pins dfx_axi_shutdown_man_1/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_a3ctrl_M02_AXI [get_bd_intf_pins dfx_axi_shutdown_man_0/S_AXI] [get_bd_intf_pins axi_a3ctrl/M02_AXI]
  connect_bd_intf_net -intf_net axi_a3ctrl_M03_AXI [get_bd_intf_pins axi_a3ctrl/M03_AXI] [get_bd_intf_pins dfx_decoupler_0/s_axi_reg]
  ...
  connect_bd_intf_net -intf_net axi_a3data_M00_AXI [get_bd_intf_pins axi_a3data/M00_AXI] [get_bd_intf_pins dfx_axi_shutdown_man_1/S_AXI]
  ...
  connect_bd_intf_net -intf_net dfx_axi_shutdown_man_0_M_AXI [get_bd_intf_pins artico3_base/s00_axi] [get_bd_intf_pins dfx_axi_shutdown_man_0/M_AXI]
  connect_bd_intf_net -intf_net dfx_axi_shutdown_man_1_M_AXI [get_bd_intf_pins artico3_base/s01_axi] [get_bd_intf_pins dfx_axi_shutdown_man_1/M_AXI]

  # Create port connections
  connect_bd_net -net artico3_shuffler_0_interrupt  [get_bd_pins artico3_base/interrupt] \
  [get_bd_pins dfx_decoupler_0/rp_irq_INTERRUPT]
  connect_bd_net -net dfx_decoupler_0_s_irq_INTERRUPT  [get_bd_pins dfx_decoupler_0/s_irq_INTERRUPT] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net reset_0_interconnect_aresetn  [get_bd_pins reset_0/interconnect_aresetn] \
  ...
  connect_bd_net -net reset_0_peripheral_aresetn  [get_bd_pins reset_0/peripheral_aresetn] \
  [get_bd_pins artico3_base/s_axi_aresetn] \
  [get_bd_pins axi_a3ctrl/M03_ARESETN] \
  [get_bd_pins dfx_axi_shutdown_man_0/resetn] \
  [get_bd_pins dfx_axi_shutdown_man_1/resetn] \
  [get_bd_pins dfx_decoupler_0/s_axi_reg_aresetn]
  ...
  [get_bd_pins artico3_base/s_axi_aclk] \
  ...
  [get_bd_pins axi_a3ctrl/M03_ACLK] \
  ...
  [get_bd_pins dfx_decoupler_0/aclk] \
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00100000 -with_name SEG0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs artico3_base/artico3_shuffler_0/s00_axi/reg0] -force
  assign_bd_address -offset 0xB0000000 -range 0x00100000 -with_name SEG1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs artico3_base/artico3_shuffler_0/s01_axi/reg0] -force
  assign_bd_address -offset 0xA0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dfx_axi_shutdown_man_0/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0xA0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dfx_axi_shutdown_man_1/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0xA0120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dfx_decoupler_0/s_axi_reg/Reg] -force
