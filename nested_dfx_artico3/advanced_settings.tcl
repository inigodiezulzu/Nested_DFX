...
set_attribute module $static vhdl       [list [glob .gen/sources_1/bd/system/hdl/*.vhd]]
...
foreach rp [array names rm_variants] {
  foreach rm $rm_variants($rp) {
    ...
    set_attribute module $variant vhdl         [list .srcs/sources_1/bd/$variant/hdl/*_wrapper.vhd]
